...
else
{
	...
	$ezride_profile = filter_var($_POST['profile'], FILTER_SANITIZE_STRING);
	...
	$query = "INSERT INTO userinfo (username, password, email, profile) VALUES ('$ezride_username', '$ezride_password', '$ezride_email', '$ezride_profile')";
