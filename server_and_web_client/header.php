      ...
      <div class="container nav-container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav my-nav-nav">
            ...
            <?php if(isset($_SESSION['gplusuer'])): ?>
            <li id="mygroup"><a href="mygroups.php">Mygroups</a></li>
            <?php endif?>
         ...
         <?php if ($user): ?>
          ...
          <?php else: ?>
            ...
            <?php elseif(isset($_SESSION['gplusuer'])): ?>
                 <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                      
                       <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                       <span><img style="width:32px; height:32px; margin:0px; padding:2px; margin-bottom: -8px; margin-top: -10px; margin-right: 5px;" class="img-rounded" src="<?php echo $me['image']['url']?>"><span><?php echo $me['displayName'] ?></span><b class="caret"></b></span>
                       </a>
                        <ul class="dropdown-menu">
                          <li><?php  print "<a class='logout' href='?logout'>Logout</a>";?></li>
                          <li><a href="#">Another action</a></li>
                          <li><a href="#">Something else here</a></li>
                          <li><a href="#">Separated link</a></li>
                        </ul>
